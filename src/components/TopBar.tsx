  ...
  return (
    <div className="relative">
      <div className="sticky bg-lightGrey top-0 z-50 h-max-content w-full shrink-0 items-center justify-between bg-background flex p-7 md:pb-7 md:pr-6 md:p-0 2xl:p-0 flex-row gap-4">
        <div className="flex flex-col gap-1 min-w-1/3 shrink md:shrink-0">
      ...
      <div
        className={clsx(
          "md:hidden right-0 absolute z-50 w-0 backdrop-blur  flex flex-col items-end duration-200 transition-all overflow-hidden",
          { "h-[calc(100vh-104px)] w-screen": sidebarOpen }
        )}
      >
        <NavigationBar />
      </div>
